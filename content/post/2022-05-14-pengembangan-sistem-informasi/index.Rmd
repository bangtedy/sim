...
date: '2022-05-14'
slug: pengembangan-sistem-informasi
categories:
  - Materi
tags:
  - pengembangan sistem
...
- `r emo::ji('check')` mengembangkan sistem informasi; 
- `r emo::ji('check')` memahami metode SDLC; 
- `r emo::ji('check')` menjelaskan analisis sistem informasi pada organisasi; 
- `r emo::ji('check')` menjelaskan desain sistem informasi pada organisasi; 
- `r emo::ji('check')` menjelaskan implementasi sistem informasi pada organisasi; 
- `r emo::ji('check')` memahami strategi konversi; 
- `r emo::ji('check')` menjelaskan pemeliharaan sistem informasi; 
- `r emo::ji('check')` memahami metodologi pengembangan sistem terstruktur; 
- `r emo::ji('check')` memahami pendekatan top-down pada metodologi pengembangan sistem 
terstruktur; 
- `r emo::ji('check')` memahami pendekatan decomposition pada metodologi pengembangan 
sistem terstruktur; 
- `r emo::ji('check')` memahami alat-alat yang digunakan di metodologi pengembangan 
sistemn terstruktur. 
...
## `r emo::ji('books')` KEGIATAN BELAJAR 1: Siklus Hidup Pengembangan Sistem 
...
## `r emo::ji('books')` KEGIATAN BELAJAR 2: Metodologi Pengembangan Sistem lnformasi Terstruktur 
...
<!-- AddToAny BEGIN -->
<div class="a2a_kit a2a_kit_size_16 a2a_default_style"; data-a2a-url="https://bangtedy.github.io/etan" data-a2a-title="Pengembangan Sistem Informasi">
