...
![](24-siklus-pengolahan-data.png)
Apakah komponen pada Gambar 2.4 sudah cukup `r emo::ji ("question")`
...
Apakah komponen pada Gambar 2.5 sudah cukup `r emo::ji ("question")`
...
![](211-komponen-pengendalian.png)

G. KOMPONEN MANUSIA

![](212-komponen-manusia.png)


<!-- AddToAny BEGIN -->
<div class="a2a_kit a2a_kit_size_16 a2a_default_style"; data-a2a-url="https://bangtedy.github.io/sim" data-a2a-title="Konsep Sistem Informasi">
